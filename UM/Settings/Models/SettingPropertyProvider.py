...
class SettingPropertyProvider(QObject):
    ...
    def setPropertyValue(self, property_name, property_value):
        ...
        resolve_property = self._property_values.get("resolve", None)

        if property_name == "value" and self._remove_unused_value and (resolve_property == property_value or resolve_property is None or resolve_property == "None"):
