...
class VersionUpgradeManager:
    ...
    #   plug-in.
    def _addVersionUpgrade(self, version_upgrade) -> None:
    ...
    def _upgradeFile(self, storage_path_absolute: str, configuration_file: str, old_configuration_type: str) -> bool:
        ...
        try:
            mime_type = MimeTypeDatabase.getMimeTypeForFile(configuration_file)
        ...
        if version != old_version or configuration_type != old_configuration_type:
            ...
            mime_type = MimeTypeDatabase.getMimeType(mime_type_name)  # Get the actual MIME type object, from the name.
