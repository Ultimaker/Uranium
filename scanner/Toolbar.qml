        ...
        Item
        {
            ...
            Row
            {
                ...
                Button 
                {
                    ...
                    checked: UM.ToolbarData.state == 12 ? true:UM.ToolbarData.state == 13? true:UM.ToolbarData.state == 14? true:false
                ...
                Button 
                {
                    ...
                    checked: UM.ToolbarData.state == 15 ? true:false
                    onClicked: {UM.ToolbarData.setState(15)}
                }
            }
        }
        Item
