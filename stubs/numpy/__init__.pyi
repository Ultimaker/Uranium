...
def seterr(all: str=None, divide: str=None, over: str=None, invalid: str=None) -> Dict[str, str]: ...

class finfoobj:
    eps = None        # type: float
    epsneg = None     # type: float
    iexp = None       # type: int
    #machar = None     # type: MachAr
    machep = None     # type: int
    max = None        # type: float
    maxexp = None     # type: int
    min = None        # type: float
    minexp = None     # type: int
    negep = None      # type: int
    nexp = None       # type: int
    nmant = None      # type: int
    precision = None  # type: int
    resolution = None # type: float
    tiny = None       # type: float

def finfo(dtype: Any) -> finfoobj: ...

def logical_and(x1: _ArrayLike[Any], x2: _ArrayLike[Any]) -> Union[ndarray[Any], bool]: ...
def logical_or(x1: _ArrayLike[Any], x2: _ArrayLike[Any]) -> Union[ndarray[Any], bool]: ...
def logical_not(x: _ArrayLike[Any]) -> Union[ndarray[Any], bool]: ...
def logical_xor(x1: _ArrayLike[Any], x2: _ArrayLike[Any]) -> Union[ndarray[Any], bool]: ...
def arange(start=0, stop=0, step=1, dtype: DtypeType=None) -> ndarray[Any]: ...
